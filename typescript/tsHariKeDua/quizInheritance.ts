{
    ...
    class SUV extends dataVehicle implements total {
        ...
        private vehicleSUV = this.vehicle.filter(value => value.vehicleType === 'SUV');
        ...
        getTotalIncomeVehicle() {
            ...
            return `Total income untuk kendaraan SUV adalah ${jumlah}`;
        }
    }
    ...
    class Taxi extends dataVehicle implements total {
        ...
        private vehicleTaxi = this.vehicle.filter(value => value.vehicleType === 'Taxi');
        ...
        getTotalVehicle() {
            return `Jumlah kendaraan dengan tipe SUV adalah ${this.vehicleTaxi.length}`;
        }
    ...
    class PrivateJet extends dataVehicle implements total {
        ...
        private vehicleJet = this.vehicle.filter(value => value.vehicleType === 'PrivateJet');
        ...
        getTotalVehicle() {
            return `Jumlah kendaraan dengan tipe SUV adalah ${this.vehicleJet.length}`;
        }
    ...
    // console.log(vehicleObj.getVehicleData());
    // console.log(suvObj.getVehicleData());
    // console.log(taxiObj.getVehicleData());
    // console.log(jetObj.getVehicleData());
    }