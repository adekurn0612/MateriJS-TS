...
// class elektronik{
//     constructor  (public jenis:string , public harga:string){}
//     protected getInfo(){
//         return `jenis ${this.jenis} dan harga ${this.harga}`
//     }
// }

// class elektrokikNew extends elektronik{
//     constructor (jenis:string , harga:string, public tahun:number){
//         super(jenis,harga)

        
//     }
//     getInfoNew(){
//         return super.getInfo()+ `nama ${this.tahun},`
//     }
// }

// let elektronikObj =new elektrokikNew `wireles , 500000, `